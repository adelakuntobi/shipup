    ...
    <section className="container py-24">
      ...
      <div>
        ...
        <OperationsDiv className="grid-cols-2">
          <div data-aos="fade-right" data-aos-duration="700" className="w-full md:w-4/12">
          ...
          <img data-aos="fade-left" data-aos-duration="700"
           className="w-full md:w-4/12" src="/images/operations1.svg" />
        </OperationsDiv>
        ...
        <OperationsDiv className="!flex-col-reverse md:!flex-row">
          <img data-aos="fade-left" data-aos-duration="700" className="w-full md:w-4/12" src="/images/operations2.svg" />
          <div data-aos="fade-right" data-aos-duration="700" className="w-full md:w-4/12">
            <div className="withNo">
              <span>2</span>
              <h6>Store</h6>
        ...
        <OperationsDiv className="grid-cols-2">
          ...
          <img data-aos="fade-left" data-aos-duration="700" className="w-full md:w-4/12" src="/images/operations3.svg" />
        </OperationsDiv>
